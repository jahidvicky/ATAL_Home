...
//   // Helper: safely extract transaction id from PayPal response
//   const getPayPalTransactionId = (details) => {
//     // capture id often lives here, but defensively check both places
//     return (
//       details?.id ||
...
//         discount,
//         coupon,
//         ...payload, // safe now, payload defaults to {}
//       });
...
//   const handlePayPalFail = () => {
//     // Optional: you might not want to create an order on PayPal failure.
//     // If you do want to track failed attempts, keep this. Otherwise remove the createOrder call.
//     createOrder({
//       paymentMethod: "PayPal",
//       paymentStatus: "Failed",
//       transactionId: null,
