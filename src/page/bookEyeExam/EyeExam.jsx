...
const EyeExam = () => {
  ...
  const { doctorName, doctorImage, day, weekday, time, examType } =
    location.state;
  return (
    <div className="p-10 bg-white">
      ...
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-2 gap-5 border border-gray-300 rounded-lg p-8 w-300">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-700">{examType}</p>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-start">
                ...
                <p className="text-sm text-gray-600">
                  I declare that all the information provided in this form are
                  true, complete and accurate and I agree to send my personal
                  information to my clinic for the processing of my appointment
                  request.
                </p>
              </div>
            </div>
            ...
            {/* Button */}
            <button className="w-full rounded-md p-3 bg-red-600 text-white mt-6 hover:bg-black">
              BOOK AN APPOINTMENT
            </button>
          </div>
        </div>
