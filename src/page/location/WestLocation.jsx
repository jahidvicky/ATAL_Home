                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-4 text-sm">
                                10 Henderson Ave Unit #4, Brampton, ON L6Y 2A4, Canada
                            </p>

                            <div className=" h-[330px] border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                                <iframe
                                    src="https://www.google.com/maps?q=10+Henderson+Ave+Unit+4,+Brampton,+ON+L6Y+2A4,+Canada&output=embed"
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
                                    loading="lazy"
