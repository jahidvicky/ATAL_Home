        ...
        <div className="bg-gray-50 text-gray-900 overflow-hidden">
            ...
            >
                <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black">
                    ...
                    <span className="text-[#f00000]">Atal Optical Specialists</span>
                </h2>
            ...
            <section className="relative bg-[#f00000] text-white py-20 md:py-28 -skew-y-2">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-6xl mx-auto px-6 md:px-20 text-center mb-10">
                    <h3 className="text-3xl font-bold text-black mb-4">
                        Meet Our <span className="text-[#f00000]">Experienced Team</span>
                    </h3>
