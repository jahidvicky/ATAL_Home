        ...
        <div className="bg-white text-gray-900">
            ...
            >
                <h2 className="text-3xl md:text-4xl font-bold text-black mb-6">
                    The Identity of <span className="text-[#f00000]">Atal Optical</span>
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                <motion.div
                    ...
                    transition={{ duration: 0.8 }}
                    className="bg-[#f00000] text-white p-10 md:p-16 flex flex-col justify-center"
                >
                ...
                >
                    <h3 className="text-2xl font-semibold mb-4 text-[#f00000]">
                        Our Brand Promise
                    </h3>
            ...
            >
                ...
                <div className="bg-black text-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
                    <h4 className="text-xl font-semibold text-[#f00000] mb-3">Quality</h4>
