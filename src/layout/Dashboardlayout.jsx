                ...
                <nav className="space-y-2 text-center text-lg font-semibold mt-4">
                    {menuItems.map((item) => (
                        <Link
                            key={item.path}
                            to={item.path}
                            className={`border-b-1 block px-4 py-2 rounded hover:bg-gray-500 hover:text-white hover:cursor-pointer ${location.pathname === item.path
            ...
            <div className="flex-1 flex flex-col">
                ...
                <header className="bg-white shadow-md px-6 py-5 flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button className="px-3 py-1 bg-[#f00000] text-white rounded hover:bg-[#f00000] text-xl hover:cursor-pointer">
                            Logout
                        </button>
                    </div>
                </header>
