      ...
      >
        <div className="flex ">
          ...
          <div className="bg-white mt-14 md:mr-26 md:w-160 rounded-br-2xl">
            <h1 className="text-3xl font-bold mt-10 ml-10"> OUR <span className="text-[#f00000]">PROMOTIONS</span> </h1>
            ...
            <div className="flex items-center ml-10 mb-8">
              ...
              <span>
                <TbMathGreater className="bg-[#f00000] rounded-full text-center text-white text-3xl p-1 hover:rotate-180 hover:cursor-pointer" />
              </span>
