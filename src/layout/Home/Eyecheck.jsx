  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between px-14 py-12 bg-white gap-x-30">
      ...
      <div className="mb-8 md:mb-0 md:ml-10 md:w-1/2">
        ...
        <Link to="/eye-check-details"><button className="flex items-center gap-4 text-white font-medium bg-[#f00000] px-4 py-2 rounded mr-22 hover:bg-black hover:cursor-pointer transition-colors duration-300 hover:cursor-pointer">
          Learn More
